...
Free_Throws_Attempts_per_Game=Free_Throws_Attempts/Games
accuracy=Free_Throws/Free_Throws_Attempts
part_3=Points-Free_Throws/FieldGoals
#exit(0)

def myplot(data, playersList=Players):
    col={"KobeBryant":"Black","JoeJohnson":"Blue","LeBronJames":"Green","CarmeloAnthony":"Red","DwightHoward":"Magenta","ChrisBosh":"Yellow","ChrisPaul":"Red","KevinDurant":"Black","DerrickRose":"Red","DwayneWade":"Blue"}
    mrk={"KobeBryant":"s","JoeJohnson":"o","LeBronJames":"^","CarmeloAnthony":"D","DwightHoward":"p","ChrisBosh":"8","ChrisPaul":"P","KevinDurant":"x","DerrickRose":"<","DwayneWade":">"}
    for name in Players:
    ...
    #plt.ylabel("Free_Throws_Attempts_per_Game")
    plt.show()

myplot(Free_Throws_Attempts_per_Game)
myplot(accuracy)
myplot(part_3)